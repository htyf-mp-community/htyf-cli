...
const playList = [
  {
    data: {
      page: '/playground/pages/explore/animate/lottie/index'
    },
    title: 'Lottie',
    showRightArrow: true
  },
  {
    data: {
      page: '/playground/pages/explore/others/linear-gradient/index'
    },
...
if(isRN) {
  playList.push({
    data: {
      page: '/playground/pages/explore/charts/entry'
    },
    title: 'Echarts',
    showRightArrow: true
  })
...
function loadDemo({ web, title, mp }) {
  if (isWeb) {
    web &&
      loadWeb({
        url: web,
