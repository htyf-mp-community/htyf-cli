...
import { switchTab, navigateTo, redirectTo, navigateBack, getCurrentPages, reLaunch } from '@tarojs/taro';
  ...
  return <View className="global-page">
    ...
    <View className="global-page__body">
      ...
      <Button className='global-page-btn' type='primary' onClick={()=>{
        navigateTo({
          url: `/playground/pages/global/pages/router/index?index=${i++}&from=navigateTo`
      })}}
      >navigateTo</Button>
      <Button className='global-page-btn' type='primary' onClick={()=>{
        redirectTo({
          url: `/playground/pages/global/pages/router/index?index=${i++}&from=redirectTo`
      })}}
      >redirectTo</Button>
      <Button className='global-page-btn' type='primary' onClick={()=>{
        navigateBack()
      ...
      <Button className='global-page-btn' type='warn' onClick={()=>{
        reLaunch({
          url: `/playground/pages/global/pages/router/index?index=${i++}&from=reLaunch`
        })
      }}
      >reLaunch</Button>
      <Button className='global-page-btn' type='warn' onClick={()=>{
        switchTab({
          url: '/playground/pages/global/index'
        })
      }}
      >switchTab</Button>
    </View>
