# @htyf-mp/stylelint-config-taro-rn

<img src="screenshots/warning.png" width="540">

## Installation and usage

Install `@htyf-mp/stylelint-config-taro-rn` (and `stylelint` + `@htyf-mp/stylelint-taro-rn`, if you haven't done so yet):

```
yarn add stylelint @htyf-mp/stylelint-taro-rn @htyf-mp/stylelint-config-taro-rn --dev
```

or

```
npm install stylelint @htyf-mp/stylelint-taro-rn @htyf-mp/stylelint-config-taro-rn --save-dev
```

Create the `.stylelintrc` config file (or open the existing one) and extend `@htyf-mp/stylelint-config-taro-rn` config.

```json
{
  "extends": "@htyf-mp/stylelint-config-taro-rn",
  "rules": {
