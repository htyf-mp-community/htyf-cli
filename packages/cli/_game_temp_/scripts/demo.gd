...
func _bind_buttons() -> void:
    ...
    _bind_button("Scroll/Main/GetMenuRectSyncButton", _on_get_menu_button_bounding_client_rect_sync)
...
func _on_get_menu_button_bounding_client_rect_sync() -> void:
    HtyfSdk.log("getMenuButtonBoundingClientRectSync")
    var data: Dictionary = HtyfSdk.get_menu_button_bounding_client_rect_sync()
    print("getMenuButtonBoundingClientRectSync result: ", data)
    HtyfSdk.call_show_modal("success", "getMenuButtonBoundingClientRectSync result: " + JSON.stringify(data))
