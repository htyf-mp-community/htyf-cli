...
type PlatformType = 'ios' | 'android' | 'harmony'
...
const Index: React.FC<ActionSheetProps> = ({
  visible,
  style,
  maskStyle,
  onShow,
  ...
  let _type = type
  if (autoDectect) _type = Platform.OS as PlatformType
      ...
      >
        <Text
          style={[
            ...
            styles[`${_type}ActionsheetCellText` as keyof typeof styles],
            styles[`${btnType}ActionsheetCellText` as keyof typeof styles],
            textStyle
          ]}
        >{label}</Text>
      </TouchableHighlight>
