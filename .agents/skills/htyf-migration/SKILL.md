...
2. Read [the migration rules](references/migration-rules.md) completely
   ...
   storage, dependency, code-documentation, native-source, overlay,
   header-layout, testing, and acceptance constraints for this skill.
...
4. Implement vertical slices in the target using its existing architecture.
   ...
   code documentation, and tests before marking it migrated.
